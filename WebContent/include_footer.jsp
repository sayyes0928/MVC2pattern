		...
		<div class="layout-footer__top">
			<address class="layout-footer__cs">
				<div class="layout-footer__cs__row">
					<a class="layout-footer__cs__link" href="qna.bo">고객센터s<svg
				...
				<div class="layout-footer__cs__row">
					<a class="layout-footer__cs__tel" href="#">1234-5678</a>
				</div>
		...
		<address class="layout-footer__info-wrap">
			<dl class="layout-footer__info">
				...
				<span class="layout-footer__info__item"><dt>주소</dt>
					<dd>서울특별시 서초구 서초대로 </dd></span>
			</dl>
			<dl class="layout-footer__info">
				<span class="layout-footer__info__item"><dt>NICEPAY 안전거래
						서비스</dt>
					<dd>
			...
			<span class="layout-footer__info"><span
				class="layout-footer__info__item">(주)자취해보자는 통신판매중개자로서 통신판매의
