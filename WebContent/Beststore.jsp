...
<header>
	...
	<div id="firsec_size">
		<a href="korea.bo?pro_num=<%=article.get(0).getPro_code()%>"><div id="firstbt" style="background-image: URL(<%=request.getContextPath()%>/upload/<%=article.get(0).getPro_mainimg()%>); background-repeat: no-repeat;">
		...
		<a href="korea.bo?pro_num=<%=article.get(1).getPro_code()%>"><div id="secbt"  style="background-image: URL(<%=request.getContextPath()%>/upload/<%=article.get(1).getPro_mainimg()%>); background-repeat: no-repeat;">
	...
	<div id="namugi">
		<a href="korea.bo?pro_num=<%=article.get(2).getPro_code()%>">
		...
		<a href="korea.bo?pro_num=<%=article.get(3).getPro_code()%>">
		...
		<a href="korea.bo?pro_num=<%=article.get(4).getPro_code()%>">
