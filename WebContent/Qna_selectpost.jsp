	...
	<form name="go" action="NewFile.jsp">
		<header>
			<div id="h_wrap">
				...
				<div class="h_div">
					<ul>
						<li style="padding-top: 110px"><img src="grass2icon.svg"
							width="30" height="30" /></li>
						<li style="padding-top: 80px"><img src="truck2.svg"
							width="70" height="70" /></li>
						<li><img src="sunicon.svg" width="60" height="60" /></li>
						<li style="padding-top: 110px"><img src="grass2icon.svg"
							width="30" height="30" /></li>
						<li style="padding-top: 100px"><img src="grassicon.svg"
							width="40" height="40" /></li>

						<li><h1>자취해보자</h1></li>
						<li style="padding-top: 20px"><img src="houseiconcolor.svg"
							width="100" height="100" onmouseover="this.src='houseicon.svg'"
							onmouseout="this.src='houseiconcolor.svg'" /></li>
						<li style="padding-top: 100px"><img src="grassicon.svg"
							width="40" height="40" /></li>
						<li style="padding-top: 100px"><img src="grassicon.svg"
							width="40" height="40" /></li>
