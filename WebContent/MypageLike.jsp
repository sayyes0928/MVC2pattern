...
<body>
	<%
		ArrayList<BeautyRoomDTO> likeList = (ArrayList<BeautyRoomDTO>) request.getAttribute("likeList");
	%>
	<!-- 게시판 등록 -->
	<form id="contentPage">
		<!-- Header include -->
		...
		<nav class="page-navigation collection-book-nav">
			<ul style="transform: translateX(0px);">
				<li class="page-navigation__item"><a class="active"
					href="/users/8659285/collections" target="_self">상품 및 게시글 모아보기(<%= likeList.size()%>)</a></li>
			</ul>
		</nav>
		<div class="container">
			...
			<div class="virtualized-list collection-feed-collections row"
				...
				<div class="col-6 col-md-4 col-lg-3">
					<a
						href="Beautyroom_Detail.bo?board_num=<%=likeList.get(i).getPost_num()%>">
						<div class="collection collection--total">
							<div class="collection__image-wrap">
								<img class="collection__image"
									src="<%=request.getContextPath()%>/upload/<%=likeList.get(i).getPost_pic()%>">
							</div>
