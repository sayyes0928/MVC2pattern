              ...
              <ul>
                <li><a href="#">침구</a>
                  <ul>
                    ...
                    <li><a href="#">토퍼</a></li>
                    <li><a href="#">베개커버</a></li>
                    <li><a href="#">바디필로우</a></li>
                    <li><a href="#">매트리스커버</a></li>
                  </ul>
                </li>
                <li><a href="#">커튼/블라인드</a>
                  <ul>
            ...
            <div class="m_img">
              <ul>
                <li>
                  <div class="row">
                    <figure class="effect1">
                      <a href="teampro_store.html"><img class="m_imgsize" src="img/page_store/p_1.png">
                      <figcaption>
                        <p>제품 상세 정보</p>
                      </figcaption>
                    </figure>
                  </div>
                  <div class="m_pname">스테이 2인 가죽소파</div>
                  <div class="m_pindex">2clolors</div>
                  <div class="m_pindex2">319,000</div>
                  </a>
                ...
                <li>
                  ...
                  <div class="m_pindex2">175,000</div>
                </a>
                </li>
                <li><div class="row">
                  <figure class="effect1">
                    <a href="teampro_store.html"><img class="m_imgsize" src="img/page_store/p_3.png">
                    <figcaption>
                      <p>제품 상세 정보</p>
                    </figcaption>
                  </figure>
                  ...
                  <div class="m_pindex2">68,900</div>
                </a>
                </li>
                <li>
                  <div class="row">
